		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#callgeneratior-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"callgeneratior-display": {
								"semanticObject": "callgeneratior",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=callgeneratior",
									"url": sap.ui.require.toUrl("callgeneratior")
								}
							}
						}
					}
